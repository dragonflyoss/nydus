...
func (s *stubStore) Status(context.Context, string) (content.Status, error) { return content.Status{}, nil }

func (s *stubStore) ListStatuses(context.Context, ...string) ([]content.Status, error) { return nil, nil }
...
type nopReaderAt struct{ io.ReaderAt }
