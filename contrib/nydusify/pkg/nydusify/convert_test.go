...
func convert(t *testing.T, source io.ReadCloser, workDir string) (io.Reader, digest.Digest) {
	...
	defer source.Close()
	nydusTarReader, err := Convert(context.TODO(), source)
	require.NoError(t, err)
...
func TestConverter(t *testing.T) {
	...
	lowerNydusTarReader, lowerNydusBlobDigest := convert(t, lowerOCITarReader, blobDir)
	upperNydusTarReader, upperNydusBlobDigest := convert(t, upperOCITarReader, blobDir)
