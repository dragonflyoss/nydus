...
require (
	...
	github.com/goharbor/acceleration-service v0.2.1
...
require (
	...
	github.com/containerd/nydus-snapshotter v0.7.1 // indirect
	github.com/containerd/stargz-snapshotter v0.14.2 // indirect
