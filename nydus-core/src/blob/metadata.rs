...
pub(crate) const BLOB_META_MAGIC: [u8; 8] = *b"LPBLMETA";
...
pub(crate) const BLOB_META_VERSION: u32 = 1;
...
pub(crate) const BLOB_META_HEADER_SIZE: u64 = EROFS_BLOCK_SIZE as u64;
...
impl BlobMetaHeader {
    ...
    fn validated_flags(&self) -> Result<BlobMetaFlags> {
        ...
        validate_incompat_flags(self.flags, BlobMetaFlags::all().bits(), "blob meta")?;
...
impl BlobMeta {
    ...
    fn compute_crc32(&self) -> u32 {
        ...
        // records and padding.
        let mut crc32 =
            crc32_with_zeroed_field(&self.header.to_bytes_with_crc32(0), blob_meta_crc32_field());
...
fn compute_blob_meta_crc32(data: &[u8]) -> u32 {
    crc32_with_zeroed_field(data, blob_meta_crc32_field())
}

fn blob_meta_crc32_field() -> std::ops::Range<usize> {
    BLOB_META_HEADER_CRC32_OFFSET..BLOB_META_HEADER_CRC32_OFFSET + 4
}
