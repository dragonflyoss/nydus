...
impl TraceRecorder {
    ...
    /// pair are ignored.
    pub(crate) fn record_group_access(&self, blob_index: u32, group_index: u32) {
    ...
    pub(crate) fn snapshot(&self) -> TraceDocument {
    ...
    pub(crate) fn encode_json(&self) -> String {
...
pub(crate) fn record_group_access(blob_index: u32, group_index: u32) {
