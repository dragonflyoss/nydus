...
func IsNydusBlob(desc ocispec.Descriptor) bool {
	return desc.MediaType == pkgconv.MediaTypeNydusBlob
}
...
func IsNydusBootstrap(desc ocispec.Descriptor) bool {
	...
	_, ok := desc.Annotations[pkgconv.LayerAnnotationNydusBootstrap]
	return ok
}
...
func IsNydusOptimizedBlob(desc ocispec.Descriptor) bool {
	...
	_, ok := desc.Annotations[pkgconv.LayerAnnotationNydusBlobOptimized]
	return ok
}
