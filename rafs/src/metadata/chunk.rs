...
mod tests {
    ...
    fn test_chunk_wrapper_copy_from() {
        ...
        test_copy_from(wrapper_v6.clone(), wrapper_v5.clone());
        test_copy_from(wrapper_v6.clone(), wrapper_v6.clone());
    }
    ...
    fn test_ref_copy1() {
        ...
        test_copy_from(wrapper_ref.clone(), wrapper_ref.clone());
    }
    ...
    fn test_ref_copy2() {
        ...
        test_copy_from(wrapper_ref.clone(), wrapper_v5.clone());
    }
    ...
    fn test_ref_copy3() {
        ...
        test_copy_from(wrapper_ref.clone(), wrapper_v6.clone());
    }
    ...
    fn test_ref_copy4() {
        let wrapper_ref = ChunkWrapper::Ref(Arc::new(MockChunkInfo::default()));
        let wrapper_v6 = ChunkWrapper::Ref(Arc::new(TarfsChunkInfoV6::new(0, 0, 0, 0)));
        test_copy_from(wrapper_v6.clone(), wrapper_ref.clone());
    }
    ...
    fn test_ref_copy5() {
        let wrapper_ref = ChunkWrapper::Ref(Arc::new(MockChunkInfo::default()));
        let wrapper_v5 = ChunkWrapper::Ref(Arc::new(CachedChunkInfoV5::default()));
        test_copy_from(wrapper_v5.clone(), wrapper_ref.clone());
    }
}
