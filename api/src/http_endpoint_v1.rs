...
mod tests {
    ...
    fn test_fs_backend_info_get_with_mountpoint() {
        ...
        let result = handler.handle_request(
            &req,
            &|_| Ok(ApiResponsePayload::FsBackendInfo("{}".to_string())),
        );
        assert!(result.is_ok());
    }
    ...
    fn test_metrics_global_handler_get() {
        ...
        let result = handler.handle_request(
            &req,
            &|_| Ok(ApiResponsePayload::FsGlobalMetrics("{}".to_string())),
        );
        assert!(result.is_ok());
    }
    ...
    fn test_metrics_access_pattern_handler_get() {
        ...
        let result = handler.handle_request(
            &req,
            &|_| Ok(ApiResponsePayload::FsFilesPatterns("[]".to_string())),
        );
        assert!(result.is_ok());
    }
    ...
    fn test_metrics_files_handler_get() {
        ...
        let result = handler.handle_request(
            &req,
            &|_| Ok(ApiResponsePayload::FsFilesMetrics("[]".to_string())),
        );
        assert!(result.is_ok());
    }
    ...
    fn test_metrics_inflight_handler_get() {
        ...
        let result = handler.handle_request(
            &req,
            &|_| Ok(ApiResponsePayload::FsInflightMetrics("{}".to_string())),
        );
        assert!(result.is_ok());
    }
    ...
    fn test_config_handler_get() {
        ...
        let result = handler
            .handle_request(&req, &|_| Ok(ApiResponsePayload::Config(HashMap::new())));
        assert!(result.is_ok());
    }
