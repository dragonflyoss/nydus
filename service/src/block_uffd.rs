...
const UFFDIO_COPY: libc::Ioctl = 0xc028aa03 as libc::Ioctl;
// _IOWR(UFFDIO, 0x04, struct uffdio_zeropage)
const UFFDIO_ZEROPAGE: libc::Ioctl = 0xc020aa04 as libc::Ioctl;
...
mod tests {
    ...
    fn test_handle_range_zero() {
        ...
        const UFFDIO_API_IOCTL: libc::Ioctl = 0xc018aa3f as libc::Ioctl;
        ...
        let ret = unsafe { libc::ioctl(uffd_fd, UFFDIO_API_IOCTL, &mut api) };
        if ret < 0 {
        ...
        const UFFDIO_REGISTER_IOCTL: libc::Ioctl = 0xc020aa00 as libc::Ioctl;
        ...
        let ret = unsafe { libc::ioctl(uffd_fd, UFFDIO_REGISTER_IOCTL, &mut reg) };
        if ret < 0 {
            unsafe {
