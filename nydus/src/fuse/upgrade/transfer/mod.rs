...
pub(in crate::fuse) use payload::{validate_fuse_connection, SessionProtection, SessionTransfer};
...
pub(in crate::fuse::upgrade) use payload::{
    receive_opaque_transfer, send_opaque_transfer, OpaqueSessionTransfer,
};
