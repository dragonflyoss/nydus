...
pub struct FuseCommand {
    ...
    #[arg(
        ...
        help = "Hot-upgrade the instance already serving this mountpoint directly, preserving its failover protection. Does not contact a supervisor; requires pidfd process control"
    )]
    upgrade: bool,
