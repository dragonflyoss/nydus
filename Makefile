...
.PHONY: build release nydusify test test-nydusify test-e2e test-fuse-continuity test-tooci test-uffd test-uffd-stability test-cache-sharing test-fanotify test-nbd test-bench test-fs test-top-images crate clean
